...
/*
//2.인자가 1개면 () 삭제
const square = name => { return `${name ** 2}`}
console.log(square(2)) 
*/
/*
// 3. {}, return 생략
...
/*
// 5-1. object 를 리턴하려고 한다면? -> return 을 명시적으로!
...
// 5-3. return문을 적지 않았을때 -> undefined 가 뜸.
returnObject = () => { key: 'value' }
console.log(returnObject())
console.log(typeof returnObject())
*/
...
// let ssafy2 // 1.변수 선언 -> let은 var와 다르게 초기화 동시에 진행되지 않음!
