...
const heights = images.map(function(height){
...
// 3. filter
// 주어진 함수의 테스트를 통과하는 모든 요소를 모아서 새로운 배열로 변환하는 헬퍼 메서드
// 원하는 요소만 필터링 가능
...
// filter - EX1.
// filter 헬퍼 메서드를 사용해서 number 배열중 50보다 큰 값만 필터링 해서
...
*/
// filter - Ex2.
// users 배열에서 admin 레벨이 true인 유저 object만 filterUsers라는 배열에 담아서 
// filterUsers. 배열의 두번째 유저 이름을 출력해보세요
/*
const users = [
...
console.log(filterUsers[filterUsers.length-1].name)
console.log(users)
*/
